...
# Form implementation generated from reading ui file 'New_TeamP.ui'
#
...
class Ui_NewTeam(object):
    ...
    def setupUi(self, NewTeam):
        ...
        self.label.setGeometry(QtCore.QRect(100, 30, 201, 61))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, NewTeam):
        ...
        NewTeam.setWindowTitle(_translate("NewTeam", "Dialog"))

...
# Form implementation generated from reading ui file 'Team_EvaluationP.ui'
#
...
class Ui_evaluate_team(object):
    ...
    def setupUi(self, evaluate_team):
        ...
        self.label.setGeometry(QtCore.QRect(80, 10, 451, 51))
        font = QtGui.QFont()
        ...
        self.points.setGeometry(QtCore.QRect(410, 160, 61, 20))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
        font.setPointSize(12)
        ...
        self.Evaluate_btn.setEnabled(False)
        self.Evaluate_btn.setGeometry(QtCore.QRect(240, 410, 141, 31))
        font = QtGui.QFont()
        font.setFamily("Comic Sans MS")
